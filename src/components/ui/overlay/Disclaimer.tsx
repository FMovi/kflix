      ...
      <ModalContent>
        ...
        <ModalBody>
          <ScrollShadow hideScrollBar className="space-y-4">
            <p>
              Welcome to KFLIX — a free and open-source movie streaming website. Please read this
              disclaimer carefully before using this website.
            </p>
            <p>
              KFLIX is developed solely for <strong>educational and learning purposes.</strong>{" "}
            ...
            <p>
              All content displayed on KFLIX (including but not limited to movies, images,
            ...
            <p>
              By using KFLIX, you acknowledge that I bear no responsibility for user actions,
            ...
            <p>
              ...
              commercial use, are strictly prohibited. By using KFLIX, you agree to these terms
